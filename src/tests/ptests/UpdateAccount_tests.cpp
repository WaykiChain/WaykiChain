...
void CreateRegScriptTx() {
	...
	int argc = 6;
	const char *argv[6] =
			{ "rpctest", "submitluacontractdeploytx", "5Vp1xpLT8D2FQg3kaaCcjqxfdFNRhxm4oy7GXyBga9",
...
void CreateRegScriptTxTest() {
	...
	int argc = 7;
	const char *argv[7] =
			{ "rpctest", "submitluacontractdeploytx", "5Vp1xpLT8D2FQg3kaaCcjqxfdFNRhxm4oy7GXyBga9","0","d:\\sdk.bin","1000000", "10" };
	CommandLineRPC(argc, const_cast<char**>(argv));
}
...
void CreateRegBetScriptTx() {
	...
	int argc = 6;
	const char *argv[6] =
			{ "rpctest", "submitluacontractdeploytx", "5SKNSaC9zRQ2YkL1oo8jGcgSAjNrbEZLJ3FqEkrUu2",
