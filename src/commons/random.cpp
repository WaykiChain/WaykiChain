...
#include "random.h"
#include "commons/compat/cpuid.h"
...
#include "commons/util/util.h"             // for LogPrint()
...
#ifdef wayki_RDRND
static_assert(CPUID_F1_ECX_RDRAND == wayki_RDRND, "Unexpected value for wayki_RDRND");
#endif
#ifdef wayki_RDSEED
static_assert(CPUID_F7_EBX_RDSEED == wayki_RDSEED, "Unexpected value for wayki_RDSEED");
#endif
...
static void SeedPeriodic(CSHA512& hasher, RNGState& rng) noexcept
{
    ...
    LogPrint(BCLog::DEBUG, "Feeding %i bytes of dynamic environment data into RNG\n", hasher.Size() - old_size);
...
static void SeedStartup(CSHA512& hasher, RNGState& rng) noexcept
{
    ...
    LogPrint(BCLog::DEBUG, "Feeding %i bytes of environment data into RNG\n", hasher.Size() - old_size);
