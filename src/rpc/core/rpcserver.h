...
extern json_spirit::Value submitdexoperatorregtx(const json_spirit::Array& params, bool fHelp);
...
extern json_spirit::Value abidefjsontobinwasm(const json_spirit::Array& params, bool fHelp);
