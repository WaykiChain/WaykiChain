...
{ LCONTRACT_DEPLOY_TX,      std::make_tuple("LCONTRACT_DEPLOY_TX",      0,          1*COIN,     1*COIN,     1*COIN      ) },
...
{ BCOIN_TRANSFER_MTX,       std::make_tuple("BCOIN_TRANSFER_MTX",       0,          1*COIN,     1*COIN,     1*COIN      ) },
