...
static const uint16_t kDefaultCdpLiquidateNonReturnRatio    = 10300;    // 0 ~ 1.03    : forced liquidation only
static const uint16_t kDefaultCdpLiquidateNonReturnRatio    = 11300;    // 1.03 ~ 1.13 : Non-return to CDP owner
static const uint16_t kDefaultCdpLiquidateNonProfitRatio    = 11500;    // 1.13 ~ 1.15 : noraml liquidation
