...
namespace dex {
    ...
    bool CDEXOrderBaseTx::CheckOrderSymbols(CTxExecuteContext &context, const TokenSymbol &coinSymbol,
        ...
        if (!pCdMan->pAssetCache->CheckAssetSymbol(coinSymbol, AssetPermType::PERM_DEX_QUOTE))
        ...
        if (!pCdMan->pAssetCache->CheckAssetSymbol(assetSymbol, AssetPermType::PERM_DEX_BASE))
