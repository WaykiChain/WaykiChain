...
namespace eosio { namespace vm {
   enum opcodes {
      ...
      EOS_VM_SYNTHETIC_OPS(EOS_VM_CREATE_ENUM)
   ...
   struct opcode_utils {
      std::map<uint16_t, std::string> opcode_map{
         ...
         EOS_VM_SYNTHETIC_OPS(EOS_VM_CREATE_MAP)
   ...
   EOS_VM_SYNTHETIC_OPS(EOS_VM_CREATE_SYNTHETIC_TYPES)
   ...
   using opcode = variant<
      ...
      EOS_VM_SYNTHETIC_OPS(EOS_VM_IDENTITY)
