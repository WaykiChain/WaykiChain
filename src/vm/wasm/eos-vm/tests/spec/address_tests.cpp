...
TEST_CASE( "Testing wasm <address_3_wasm>", "[address_3_wasm_tests]" ) {
   ...
   CHECK(to_fui32(*bkend.call_with_return(nullptr, "env", "32_good5", static_cast<uint32_t>(0))) == 2144337921);
...
TEST_CASE( "Testing wasm <address_4_wasm>", "[address_4_wasm_tests]" ) {
   ...
   CHECK(to_fui64(*bkend.call_with_return(nullptr, "env", "64_good5", static_cast<uint32_t>(0))) == 0x7ffc000000000001);
