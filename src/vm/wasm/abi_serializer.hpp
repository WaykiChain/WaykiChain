...
struct abi_serializer {
   ...
   json_spirit::Value binary_to_variant( const type_name& type, const bytes& binary, microseconds max_serialization_time ) const ;
   // json_spirit::Value binary_to_variant( const type_name& type, const bytes& binary, wasm::abi_traverse_context& ctx ) const;
   // json_spirit::Value binary_to_variant( const type_name& type, wasm::datastream<const char*>& ds, microseconds max_serialization_time ) const;
  ...
  static json_spirit::Value  unpack( const string& abi, const string& name, const bytes& data, microseconds max_serialization_time)
  {
      //try {
          json_spirit::Value abi_v;
          json_spirit::read_string(abi, abi_v);
          ...
          json_spirit::Value data_v = abis.binary_to_variant(name, data, max_serialization_time);   
          return data_v;
...
private:
   ...
   json_spirit::Value  _binary_to_variant( const type_name& type,  wasm::datastream<const char*>& ds, wasm::abi_traverse_context& ctx ) const;
